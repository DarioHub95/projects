...
static int npes;
static int nfile;
static int flag;		// se flag>0 è necessario salvare temp/PVM
static int deneb;		// se deneb>0 è un run di produzione
...
int pvm_debug(void)	// resituisce 0 se è un run di produzione...
  {
   return (deneb?0:1);
  }
